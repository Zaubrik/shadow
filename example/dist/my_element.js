...
let MyElement = class MyElement extends Shadow {
    colors = [
        "yellow",
        "green",
        "pink",
  ...
  `;
    ...
    updated() {
        this.dom.class["myLi"]?.forEach((li)=>setInterval(()=>li.style.background = this.colors[Math.floor(Math.random() * 6)], 500));
    }
    clickHandler(_e) {
...
__decorate([
    property()
], MyElement.prototype, "initUrl", void 0);
__decorate([
    property()
], MyElement.prototype, "h1Content", void 0);
__decorate([
    property()
], MyElement.prototype, "firstContent", void 0);
__decorate([
    property()
], MyElement.prototype, "secondContent", void 0);
__decorate([
    property({
        reflect: false
    })
...
], MyElement.prototype, "anchorAttributes", void 0);
